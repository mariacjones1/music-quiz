...
| Device | Layout |
| --- | --- |
| Dell desktop screen (model unknown, size 1920x1200) | ✓ |
| HP laptop screen (model unknown, size 1536 x 864) | ✓ |
| iPhone SE | ✓ |
| Pixel 5 | ✓ |
